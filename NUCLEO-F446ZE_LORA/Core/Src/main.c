...
int main(void)
{
  ...
  HAL_NVIC_SetPriority(EXTI2_IRQn, 0, 0);
    ...
    if(misc_sx126x_init(SX126X_LORA_SF9))
    {
        uart_print("SX1262 INIT OK\r\n");
    }
    else
    {
        uart_print("SX1262 INIT FAIL\r\n");
    }
  /* USER CODE END 2 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(HAL_GPIO_ReadPin(
	          SX1262_DIO1_GPIO_Port,
	          SX1262_DIO1_Pin))
	  {
	      uart_print("DIO1 HIGH\r\n");
	  }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : USER_Btn_Pin SX1262_DIO1_Pin */
  GPIO_InitStruct.Pin = USER_Btn_Pin|SX1262_DIO1_Pin;
